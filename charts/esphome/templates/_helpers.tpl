...
*/}}
{{- define "esphome.basename" -}}
{{- printf "esphome-%s-%s" (.Chart.AppVersion | replace "." "-") .Release.Name }}
{{- end }}

{{/*
Create a default pvc name
*/}}
{{- define "esphome.pvcname" -}}
{{- printf "%s-pvc" (include "esphome.basename" .) }}
{{- end }}
